...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to our Boxing Store!</h1>
                    <p>We have the best Gloves, shoes and headgear for you. No need to hunt around, we have all in one place.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/venum.jpg" alt="venum">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Venum </h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/venum1.jpg" alt="venum">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Venum red-black</h3>
                                    <p>Price: 75$</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/sting.jpeg" alt="Olympus">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Sting</h3>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/reyes.jpg" alt="reyes ">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Reyes</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/reyes1.JPG" alt="reyes">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Reyes</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/eliteshoes.jpg" alt=" eliteshoes">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>EliteShoes</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/shoesvenum.jpg" alt=" venumshoes">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>VenumShoes</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/headgear.jpg" alt="headgear ">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Headgear</h3>
